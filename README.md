...
Integracion de modo switching (pensado para otro proyecto futuro, pero aqui como un experimento)
  Modo Local: Integra bases prediseñadas con usuarios y bases de datos, pensado para un entorno offline
  Modo Server: Integra un servidor SQL ya diseñado, no genera bases de datos debido a que ya existen, pensado para un entorno de negocios y/o empresas.
